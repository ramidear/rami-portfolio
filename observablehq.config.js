  ...
  pages: [
    {
      name: "Portfolio",
      pages: [
        {name: "Marion Berries Baseball Club", path: "/marionberries/"}, {name: "Los Lobos Track Club", path: "/lobos/"}, {name: "WOU Center for Professional Pathways", path: "/woucpp/"}, {name: "Video Content & Campaigns", path: "/video-content/"},
      ]
    },
    {
      name: "About",
